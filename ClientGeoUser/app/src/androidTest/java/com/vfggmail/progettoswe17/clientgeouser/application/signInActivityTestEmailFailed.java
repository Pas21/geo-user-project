...
public class signInActivityTestEmailFailed {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void signInActivityTestEmailFailed() {
                        ...
                        childAtPosition(
                                allOf(withId(R.id.username_signIn_form),
                                        childAtPosition(
                                                ...
                                                0)),
                                0)));
        appCompatEditText.perform(scrollTo(), replaceText("gio"), closeSoftKeyboard());
                        ...
                        childAtPosition(
                                allOf(withId(R.id.username_signIn_form),
                                        childAtPosition(
                                                ...
                                                0)),
                                1)));
        appCompatEditText2.perform(scrollTo(), replaceText("cod"), closeSoftKeyboard());
                        ...
                        childAtPosition(
                                allOf(withId(R.id.username_signIn_form),
                                        childAtPosition(
                                                ...
                                                0)),
                                2)));
        appCompatEditText3.perform(scrollTo(), replaceText("cod"), closeSoftKeyboard());
                        ...
                        childAtPosition(
                                allOf(withId(R.id.username_signIn_form),
                                        childAtPosition(
                                                ...
                                                0)),
                                4)));
        appCompatEditText5.perform(scrollTo(), replaceText("gio"), closeSoftKeyboard());
                        ...
                        childAtPosition(
                                allOf(withId(R.id.username_signIn_form),
                                        childAtPosition(
                                                ...
                                                0)),
                                5)));
        appCompatEditText6.perform(scrollTo(), replaceText("cod"), closeSoftKeyboard());
